#ifndef HHMomentaryMonitor_H_
#define HHMomentaryMonitor_H_
...
class HHMomentaryMonitor
{
public:
    HHMomentaryMonitor(uint8_t addr, uint8_t intPinA, uint8_t intPinB, volatile state_t& state);
    static void ISRA();
    static void ISRB();
...
private:
    ...
    static HHMomentaryMonitor* _instance;
